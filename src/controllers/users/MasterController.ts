...
export const createMaster = async (req: Request, res: Response) => {
    ...
    try {
        ...
        // Create Master entity with percentage and commission fields
        const masterData = {
            loginId,
            user_password,
            whiteListId,
            ...
            transactionPassword: generateTransactionCode(10) || "MASTER12345",
        ...
        const createSettings = async (repo: any, settingsData: any, sportType: string) => {
            ...
            const commissionDistribution = {
                commissionUplineType: settingsData.commissionUplineType || 'master',
                ...
                partnershipUplineType: settingsData.partnershipUplineType || 'master',
