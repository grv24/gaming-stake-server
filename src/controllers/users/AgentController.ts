...
export const createAgent = async (req: Request, res: Response) => {
    ...
    try {
        ...
        // Create Agent entity with percentage and commission fields
        const agentData = {
            loginId,
            user_password,
            whiteListId,
            ...
            transactionPassword: generateTransactionCode(12) || "AGENT12345",
        ...
        const createSettings = async (repo: any, settingsData: any, sportType: string) => {
            ...
            const commissionDistribution = {
                commissionUplineType: settingsData.commissionUplineType || 'agent',
                ...
                partnershipUplineType: settingsData.partnershipUplineType || 'agent',
...
//                 maxExposure: internationalCasinoSettings.maxExposure || 0,
//                 winningLimit: internationalCasinoSettings.winningLimit || 0,
//                 commissionToType: internationalCasinoSettings.commissionToType || 'agent',
...
//                 partnershipToType: internationalCasinoSettings.partnershipToType || 'agent',
...
export const getAgentById = async (req: Request, res: Response) => {
    try {
        ...
        const [
            ...
            agent.internationalCasinoSettingId
                ? AppDataSource.getRepository(InternationalCasinoSettings).findOne({
                    where: { id: agent.internationalCasinoSettingId }
                })
                : Promise.resolve(null)
        ]);
