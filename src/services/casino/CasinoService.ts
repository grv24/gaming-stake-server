...
import { DIFF_STRUCT_CASINO_TYPES } from "../../Helpers/Request/Validation";
...
export const fetchAndUpdateCasinoOdds = async (casinoType: string) => {
  try {
    ...
    if (DIFF_STRUCT_CASINO_TYPES.includes(casinoType)) {
